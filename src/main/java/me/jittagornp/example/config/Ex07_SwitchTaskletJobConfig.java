...
import me.jittagornp.example.tasklet.UploadFileTasklet;
...
@ConditionalOnProperty(prefix = "job", value = "mode", havingValue = "SWITCH_TASKLET")
public class Ex07_SwitchTaskletJobConfig {
    ...
    public Step uploadFileStep(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
        return new StepBuilder("Upload file step", jobRepository)
                .tasklet(uploadFileTasklet, transactionManager)
                .build();
    }
